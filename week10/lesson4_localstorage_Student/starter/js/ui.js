...
function loadQuotes() {
  try {
    ...
    for(let item of parse){
      if ( !item.content || !item.author) return
      addQuote(item.content,item.author)
    }
